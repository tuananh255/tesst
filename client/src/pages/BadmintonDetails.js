          ...
          <Col sm={8}>
            <div>
              <div style={{ position: "relative" }}>
                ...
                >
                  {filterData?.hirePrice}
                </button>
              </div>
              <div className="py-4">
                <strong className="fs-3">{filterData?.name}</strong>
                <div className="fs-5 d-flex gap-2 align-items-center">
                  <FaMapMarkerAlt style={{ color: "red" }} />
                  <span>{filterData?.address}</span>
                </div>
                <div className="fs-5 d-flex gap-2 align-items-center">
                  <FaCalendarAlt style={{ color: "red" }} />
                  <span>{filterData?.calendarNow}</span>
                </div>
                <div className="fs-5 d-flex gap-2 align-items-center">
                  <BsCalendar2HeartFill style={{ color: "red" }} />
                  <span>{filterData?.calendar}</span>
                </div>
                <div className="fs-5 d-flex gap-2 align-items-center">
                  <FaUsers style={{ color: "red" }} />
                  <span>Cần tuyển :{filterData?.apply}</span>
                </div>
                <div className="fs-5 d-flex gap-2 align-items-center">
                  <SiLevelsdotfyi style={{ color: "red" }} />
                  <span>Trình độ :{filterData?.level}</span>
                </div>
                <div className="fs-5 d-flex gap-2 align-items-center">
                  <IoMdPricetag style={{ color: "red" }} />
                  <span>Giá thuê :{filterData?.hirePrice}</span>
                </div>
                <div>
